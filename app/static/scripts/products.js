...
let config = {
    product_details: {
        ...
        columns: [
            ...
            { field: 'unitPrice', text: 'Unit Price', size: '120px', searchable: true, sortable: true, render: 'money' },
            { field: 'unitsInStock', text: 'Units In Stock', size: '110px', searchable: true, sortable: true, render: 'int' },
            { field: 'unitsOnOrder', text: 'Units On Order', size: '110px', searchable: true, sortable: true, render: 'int' },
            { field: 'reorderLevel', text: 'Reorder Level', size: '110px', searchable: true, sortable: true, render: 'int' },
            { field: 'discontinued', text: 'Discontinued', size: '110px', searchable: true, sortable: true },
